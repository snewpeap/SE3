...
public interface PaperService {
    ...
    /**
     *根据用户的检索条件返回所需的结果列表
     * @param text 用户输入的检索字段类型
     * @param mode 用户选择的搜索字段
     * @param pageNumber 发出请求的页号
     * @param sortMode 用户需要的结果列表的排序方式
     * @param perPage 每页的显示数量
     * @return List<SimplePaperVO> 一个论文简略信息的VO对象的List
     */
    List<Object> search(String text, String mode, int pageNumber, String sortMode, int perPage);
